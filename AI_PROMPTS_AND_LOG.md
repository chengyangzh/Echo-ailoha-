...
## 2. 设计 Core Atlas 和 Wikipedia 的边界，而不是做 generic RAG
...
## 4. 不靠“看起来不错”的例子评价 analogy，而是专门设计 surface trap
...
## 7. Live quality failure：能给答案还不够，必须允许“拒绝检索结果并重新构造”
